(module
    ...
    ;; (func $clone8 (param $size i32) (param $ref i32) (result i32)
    ;;     (local $result i32)
    ;;     (memory.copy 
    ;;         (local.tee $result (call $allocate8 (local.get $size)))
    ;;         (local.get $ref)
    ;;         (local.get $size)
    ;;     )
    ;;     (local.get $result)
    ...
    ;; (func $clone16 (param $size i32) (param $ref i32) (result i32)
    ;;     (local $result i32)
    ;;     (memory.copy 
    ;;         (local.tee $result (call $allocate16 (local.get $size)))
    ;;         (local.get $ref)
    ;;         (i32.shl (local.get $size) (i32.const 1))
    ;;     )
    ;;     (local.get $result)
    ;; )

    ;; (func $clone32 (param $size i32) (param $ref i32) (result i32)
    ;;     (local $result i32)
    ;;     (memory.copy 
    ;;         (local.tee $result (call $allocate32 (local.get $size)))
    ;;         (local.get $ref)
    ...
    ;; (func $clone64 (param $size i32) (param $ref i32) (result i32)
    ;;     (local $result i32)
    ;;     (memory.copy 
    ;;         (local.tee $result (call $allocate64 (local.get $size)))
    ;;         (local.get $ref)
    ...
    ;; (export "clone8" (func $clone8))
    ;; (export "clone16" (func $clone16))
    ;; (export "clone32" (func $clone32))
    ;; (export "clone64" (func $clone64))
