...
export declare type ValueExports = Record<string, (...params: number[]) => number>;
...
export declare class Variable<A extends types.NumberArray> extends Value<A> {
    ...
    static discrete(): Variable<Int32Array>;
    static scalar(): Variable<Float64Array>;
    static complex(): Variable<Float64Array>;
    static spreadComplex(): Variable<Float64Array>;
