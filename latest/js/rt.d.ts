 ...
 * @deprecated
 */
export declare function modules(): {
...
export declare type RuntimeExports = {
    mem: MemExports;
    space: SpaceExports;
    delay: DelayExports;
};
export declare type RuntimeModuleNames = keyof RuntimeExports;
...
export declare function webRuntime(waPath: string): Promise<Runtime>;
export declare function webLoadRuntimeModules(waPath: string): Promise<wa.WebAssemblyModules<RuntimeModuleNames>>;
