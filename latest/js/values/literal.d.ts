...
export declare class Literal<A extends types.NumberArray> extends exps.Value<A> {
    ...
    static discrete(value: number): Literal<Int32Array>;
    static scalar(value: number): Literal<Float64Array>;
    static complex(real: number, imaginary: number): Literal<Float64Array>;
    static vector(...components: number[]): Literal<Float64Array>;
}
