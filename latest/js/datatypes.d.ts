...
export declare class Integer implements Primitive<Int32Array> {
    ...
    instructionType(module: binaryen.Module): {
        load(offset: number, align: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
        load8_s(offset: number, align: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
        load8_u(offset: number, align: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
        load16_s(offset: number, align: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
        load16_u(offset: number, align: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
        store(offset: number, align: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
        store8(offset: number, align: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
        store16(offset: number, align: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
        ...
        atomic: {
            load(offset: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
            load8_u(offset: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
            load16_u(offset: number, ptr: binaryen.ExpressionRef): binaryen.ExpressionRef;
            store(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
            store8(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
            store16(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
            rmw: {
                add(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
                sub(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
                and(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
                or(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
                xor(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
                xchg(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
                cmpxchg(offset: number, ptr: binaryen.ExpressionRef, expected: binaryen.ExpressionRef, replacement: binaryen.ExpressionRef): binaryen.ExpressionRef;
            };
            rmw8_u: {
                add(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
                sub(offset: number, ptr: binaryen.ExpressionRef, value: binaryen.ExpressionRef): binaryen.ExpressionRef;
